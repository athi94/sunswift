...
#define RX_EXT_MSG_ID		0x1C000000//18080019////00100000

#define TX_MSG_ID			0x200 //3+4*6+3 = 5*6=30
#define TX_EXT_MSG_ID		0x5C002800 //4 at the front needed for ext ID, imitating currentint:5C002800
